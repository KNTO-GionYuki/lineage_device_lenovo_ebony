...
DEVICE_PATH := device/lenovo/ebony

# Inherit from lenovo sm6375-common
include device/lenovo/sm6375-common/BoardConfigCommon.mk

# Audio
AUDIO_FEATURE_ENABLED_EXT_AMPLIFIER := true

# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := LenovoA301LV
...
BOARD_KERNEL_CMDLINE += firmware_class.path=/vendor/firmware_mnt/image:/vendor/bt_firmware
...
# Security
BOOT_SECURITY_PATCH := 2025-06-13
...
include vendor/lenovo/ebony/BoardConfigVendor.mk
